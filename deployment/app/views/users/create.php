...
<head>
  ...
  <title>Admin Dashboard - Add New User</title>
  ...
  <div class="container my-5">
    <div class="admin-form-container">
      <div class="form-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?= ROOT ?>/users" class="btn btn-sm btn-outline-secondary">
      ...
      <form method="post" enctype="multipart/form-data" id="addUserForm" class="needs-validation" novalidate>
        <div class="row">
        ...
        <input type="hidden" name="location" value="<?= esc($dorm->city) ?>, <?= esc($dorm->province) ?>">
