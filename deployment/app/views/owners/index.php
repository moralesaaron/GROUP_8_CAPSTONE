...
<div class="container my-5">
  ...
  <a href="<?= ROOT ?>/owners/create" class="btn btn-primary mb-3">Add New Owner</a>
      ...
      <?php if (!empty($users)) : ?>
        <?php foreach ($users as $index => $user): ?>
          <tr>
            ...
            <td><span class="badge bg-warning text-dark"><?= esc($user->role) ?></span></td>
            <td>
            ...
            <td>
              <a href="<?= ROOT ?>/owners/edit/<?= $user->id ?>" class="btn btn-sm btn-success">Edit</a>
              <a href="<?= ROOT ?>/owners/delete/<?= $user->id ?>" class="btn btn-sm btn-danger">Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
      <?php else: ?>
